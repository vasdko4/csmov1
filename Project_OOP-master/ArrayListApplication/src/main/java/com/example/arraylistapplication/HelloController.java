...
public class HelloController {
    ...
    private static final ArrayListServise arrayList = new ArrayListServise();
    static ArrayList<Element> arrayListElements = arrayList.getArrayList();
    ...
    protected void onDraw() {
        ...
        for (int i = 0; i < arrayListElements.size(); i++) {
            ...
            Text text = new Text((String) arrayListElements.get(i).getElement());
